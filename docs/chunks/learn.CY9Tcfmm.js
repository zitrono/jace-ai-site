import{a as createComponent,e as renderComponent,d as renderTemplate,m as maybeRenderHead}from"./vendor-astro.CPP3PFy9.js";import"kleur/colors";import"html-escaper";import{$ as $$SubpageLayout}from"./SubpageLayout.BoF-KILa.js";import{$ as $$Section,s as siteConfig}from"./components.B5wy7Hfu.js";import{a as $$Button}from"./primitives.CL8Lgxpa.js";import{$ as $$Newsletter}from"./features.dgcnjvYT.js";const $$Learn=createComponent(((e,t,a)=>renderTemplate`${renderComponent(e,"SubpageLayout",$$SubpageLayout,{title:"Learn | ralph - AI-Native Private Equity Platform"},{default:e=>renderTemplate`  ${renderComponent(e,"Section",$$Section,{spacing:"md",background:"primary",as:"section",class:"relative"},{default:e=>renderTemplate` ${maybeRenderHead()}<div class="mx-auto max-w-4xl text-center"> <h1 class="text-5xl font-bold tracking-tight text-white sm:text-6xl">Learn</h1> <p class="mt-6 text-xl text-gray-300">
Practical guides and insights for PE professionals leveraging AI
</p> </div> `})}  ${renderComponent(e,"Section",$$Section,{spacing:"sm",background:"primary",as:"section",maxWidth:"lg"},{default:e=>renderTemplate` ${renderComponent(e,"Newsletter",$$Newsletter,{title:"Executive AI Intelligence Brief",subtitle:"Strategic insights and market intelligence for PE decision makers. Weekly analysis of AI adoption trends, competitive intelligence, and implementation best practices.",variant:"enterprise",placeholder:"Enter your business email",buttonText:"Get Insights",countText:"10,000+ PE leaders and LPs receive our brief"})} `})}  ${renderComponent(e,"Section",$$Section,{spacing:"lg",background:"primary",as:"section"},{default:e=>renderTemplate` <div class="grid grid-cols-1 lg:grid-cols-3 gap-8"> <!-- Article 1 --> <article class="bg-card rounded-lg p-8 hover:bg-secondary transition-colors"> <h3 class="text-2xl font-bold text-white mb-4">
...
Read more →
</a> </article> </div> `})}  ${renderComponent(e,"Section",$$Section,{spacing:"lg",background:"primary",as:"section"},{default:e=>renderTemplate` <div class="mx-auto max-w-2xl text-center"> <h2 class="text-3xl font-bold tracking-tight text-white sm:text-4xl mb-8">
Ready to see ralph in action?
</h2> ${renderComponent(e,"Button",$$Button,{variant:"primary",size:"md",href:siteConfig.demo.url},{default:e=>renderTemplate`Book a Demo`})} </div> `})} `})}`),"/Users/zitrono/dev/web/ralph-web/src/pages/learn.astro",void 0),$$file="/Users/zitrono/dev/web/ralph-web/src/pages/learn.astro",$$url="/ralph-web/learn";export{$$Learn as default,$$file as file,$$url as url};