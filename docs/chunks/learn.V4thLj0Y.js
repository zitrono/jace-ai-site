import{a as createComponent,e as renderComponent,d as renderTemplate,m as maybeRenderHead}from"./vendor-astro.EOYbf6vM.js";import"kleur/colors";import"html-escaper";import{$ as $$Layout}from"./Layout.DhCY2AXz.js";import{a as $$Header,$ as $$Section,s as siteConfig,b as $$Footer}from"./components.DyTxeM93.js";import{$ as $$Button}from"./primitives.D2TnoxMK.js";import{$ as $$Newsletter}from"./features.R1luIUPm.js";const $$Learn=createComponent(((e,t,r)=>renderTemplate`${renderComponent(e,"Layout",$$Layout,{title:"Learn | Ralph - AI-Native Private Equity Platform"},{default:e=>renderTemplate` ${maybeRenderHead()}<div class="min-h-screen"> ${renderComponent(e,"Header",$$Header,{})} <main id="main" role="main"> <!-- Hero Section --> ${renderComponent(e,"Section",$$Section,{spacing:"md",background:"primary",as:"section",class:"relative"},{default:e=>renderTemplate` <div class="mx-auto max-w-4xl text-center"> <h1 class="text-5xl font-bold tracking-tight text-white sm:text-6xl">Learn</h1> <p class="mt-6 text-xl text-gray-300">
