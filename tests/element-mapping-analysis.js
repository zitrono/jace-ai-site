...
const jaceElements = {
  header: {
    ...
    children: [
      { tag: 'nav', classes: ['mx-auto', 'flex', 'max-w-7xl', 'items-center', 'justify-between'] },
    ],
  },
  navigation: {
    tag: 'nav',
...
const selectorStrategy = {
  ...
  cascadeAware: {
    ...
    primaryButtons:
      '.btn-primary, button[class*="primary"], button[class*="bg-primary"], button[class*="bg-surface-highlight"]',
  ...
  unified: {
    ...
    primaryButtons:
      'button[class*="primary"], button[class*="bg-primary"], button[class*="bg-surface-highlight"]',
